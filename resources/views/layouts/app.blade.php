...
<body>
    <div id="app" class="page-holder {{ request()->route('front.detail') ? 'bg-light' : null }}">
        ...
        <header class="header bg-white">
            ...
            <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="{{ route('front.home') }}"><span class="fw-bold text-uppercase text-dark">Boutique</span></a>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('front.detail') }}">Product detail</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown"><a class="dropdown-item border-0 transition-link" href="{{ route('front.home') }}">Homepage</a><a class="dropdown-item border-0 transition-link" href="{{ route('front.shop') }}">Category</a><a class="dropdown-item border-0 transition-link" href="{{ route('front.detail') }}">Product detail</a><a class="dropdown-item border-0 transition-link" href="{{ route('front.cart') }}">Shopping cart</a><a class="dropdown-item border-0 transition-link" href="{{ route('front.checkout') }}">Checkout</a></div>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">               
                    <li class="nav-item">
                ...
                <div class="col-lg-6">
                  <div class="p-4 my-md-4">
                    ...
                    <div class="row align-items-stretch mb-4 gx-0">
                      ...
                      <div class="col-sm-5"><a class="btn btn-dark btn-sm w-100 h-100 d-flex align-items-center justify-content-center px-0" href="{{ route('front.cart') }}">Add to cart</a></div>
